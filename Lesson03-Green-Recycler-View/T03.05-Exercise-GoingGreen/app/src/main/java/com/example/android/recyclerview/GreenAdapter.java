...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        viewHolder.viewHolderInstanceTextView.setText("ViewHolder index: " + viewHolderCount);
        ...
        viewHolderCount++;
        Log.e(TAG, "ViewHolder count :" + viewHolderCount);
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        final TextView viewHolderInstanceTextView;
        ...
        public NumberViewHolder(View itemView) {
            ...
            viewHolderInstanceTextView = (TextView) itemView.findViewById(R.id.tv_view_holder_instance);
        }
