...
public class MainActivity extends AppCompatActivity {
    ...
    private Cursor getAllGuests() {
        String[] projection = new String[]{WaitlistEntry._ID, WaitlistEntry.COLUMN_GUEST_NAME, WaitlistEntry.COLUMN_PARTY_SIZE, WaitlistEntry.COLUMN_TIMESTAMP};
        return mDb.query(WaitlistEntry.TABLE_NAME, projection, null, null, null, null, WaitlistEntry.COLUMN_TIMESTAMP);
    }
