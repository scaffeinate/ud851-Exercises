...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String QUERY_RESULTS_JSON = "queryResultsJson";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(QUERY_RESULTS_JSON));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(QUERY_URL, mUrlDisplayTextView.getText().toString());
        outState.putString(QUERY_RESULTS_JSON, mSearchResultsTextView.getText().toString());
    }
}